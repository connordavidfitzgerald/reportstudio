...
import { CURRENT_VERSION, migrate, type StoredAny, type StoredV4 } from './migrations'
...
export function saveSession(deck: Deck, leafIndex = 0): void {
  try {
    ...
    const json = JSON.stringify({ v: CURRENT_VERSION, deck, leafIndex } satisfies StoredV4)
